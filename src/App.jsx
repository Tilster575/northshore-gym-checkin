...
// Strips spaces, dashes, brackets, and converts UK 0 prefix
// to 44 so that "07841678043" matches "44 7841678043"
// ============================================================
function normalisePhone(input) {
  let cleaned = input.replace(/[\s\-\(\)\+]/g, '')
  // Convert leading 0 to 44 (UK mobile)
  ...
  async function handleFind() {
    ...
    try {
      ...
      if (contactMethod === 'email') {
        ...
        // Phone match — normalise both sides to handle format differences
        const inputNorm = normalisePhone(contactClean)
        matched = matches.find((m) => {
          const phoneNorm = m.phone ? normalisePhone(m.phone) : ''
          const mobileNorm = m.mobile ? normalisePhone(m.mobile) : ''
          return phoneNorm === inputNorm || mobileNorm === inputNorm
        })
      }
